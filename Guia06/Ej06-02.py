...
def test():
    ...
    venta = int(input('Ingrese una cantidad de venta (negativo para terminar): '))
    while venta >= 0:
        #Permite ir contabilizando la cantidad de ventas
        cant_venta += 1
        #Permita acumular la cantidad de ventas.-
        tot_venta+=venta
        ...
        venta = int(input('Ingrese otro cantidad de ventas (0 cero para terminar): '))
